				...
				<div class="tab-content">
						<div id="home" class="tab-pane fade in active">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									@Html.EditorFor(Function(model) model.CompanyName, New With {.htmlAttributes = New With {.class = "form-control", .id = "company"}})
					...
					<div id="menu3" class="tab-pane fade">
						...
						<div class="form-row col-lg-8">
							...
							<div class="col-sm-12 next-button">
								...
								@*@Html.ActionLink("Create Antoher for Same Company", "CreateAnother", "Agent", Model, New With {.class = "btn btn-danger"})*@
                            </div>
						</div>
					</div>
